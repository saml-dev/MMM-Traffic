...
|`waypoints`|A string containing a pipe separated list of locations that you want your route to pass through.<br><br>**Example:** <code>'PNC Arena&#124;1000 Main Street New York NY'</code>|
